...
export default class API {
  static fetchTournamentSeasons(tournamentid) {
    return fetch(
      `${config.EXTERNAL_API_URI}/seasons?tournament_id=${tournamentid}`,
      {
        method: 'GET',
        headers: {
  ...
  static fetchTournamentSeason(tournamentid, seasonid) {
    return fetch(
      `${config.EXTERNAL_API_URI}/matches?locale=en&tournament_id=${tournamentid}&season_id=${seasonid}`,
      {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
  ...
  static fetchDetailedEvent(matchid, eventid) {
    return fetch(
      `${config.EXTERNAL_API_URI}/matches/${matchid}/events/${eventid}/full_events`,
      {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
